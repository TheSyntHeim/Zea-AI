########## GROUND TRUTH FULL CODEBASE FOR MAYA ##########


# ===================================================================================
# Project: Syntheim AI Companion
# File: bot-doc.py
# Description: AI Companion Application for Emotion Detection, Documnet QA, WebSearch and Response
# Author: LALAN KUMAR
# Created: [18-03-2025]
# Updated: [20-03-2025]
# Version: 1.0.0
...
# Enhanced system message template with clearer document handling instructions
system_template = f"""
You are MAYA, an expert AI companion with emotional intelligence and document analysis capabilities, created by SYNTHEIM.
...
4. When using document information, cite your sources by referring to specific document names
5. Be specific about what parts of the documents you're using
6. Present information in a clear, concise manner
7. Do not make up information that isn't in the documents
...
if "message_log" not in st.session_state:
    st.session_state.message_log = [
        {"role": "ai", "content": "Hi! I'm Maya, your AI companion with document intelligence. What can I do for you today? You can chat with me or upload PDF documents for analysis."}
    ]
...
with input_container:
    ...
    with col1:
        # Chat input
        user_query = st.chat_input("Ask MAYA...")
